...
bind = $mainMod, V, exec, uwsm app -- kitty --class clipse clipse
bind = $mainMod, U, exec, uwsm app -- kitty --class clipse udiskie
...
windowrulev2 = size 826 450, class:(.blueman-manager-wrapped)
